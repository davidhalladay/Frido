...
COCO_PATH_STRUCTURE = {
    'train': {
        'top_level': '',
        'instances_annotations': 'train_coco_style.json',
        'files': 'VG_100K'
    },
    'validation': {
        'top_level': '',
        'instances_annotations': 'val_coco_style.json',
        'files': 'VG_100K'
    }
}
...
class AnnotatedObjectsVg(AnnotatedObjectsDataset):
    def __init__(self, use_things: bool = True, use_stuff: bool = False, img_id_file=None, caption_ann_path=None, 
